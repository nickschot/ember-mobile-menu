...
module('Integration | Component | mobile-menu', function(hooks) {
  ...
  test('it renders', async function(assert) {
    await render(hbs`<MobileMenu @register={{this.register}} @unregister={{this.unregister}} @parentBoundingClientRect={{hash}}/>`);
  ...
  test(`it is a right menu if type is 'right'`, async function(assert){
    ...
    await render(hbs`<MobileMenu @type="right" @register={{this.register}} @unregister={{this.unregister}} @parentBoundingClientRect={{hash}}/>`);
  ...
  test(`it doesn't add a mask by if maskEnabled=false`, async function(assert){
    ...
    await render(hbs`<MobileMenu @maskEnabled={{false}} @register={{this.register}} @unregister={{this.unregister}}/> @parentBoundingClientRect={{hash}}`);
