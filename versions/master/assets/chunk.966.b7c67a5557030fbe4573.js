"use strict";(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[966],{8966:(e,t,n)=>{let r
function o(e){r=e}function i(){return r}n.r(t),n.d(t,{blur:()=>xt,clearRender:()=>et,click:()=>$t,currentRouteName:()=>fe,currentURL:()=>pe,doubleClick:()=>jt,fillIn:()=>Xt,find:()=>en,findAll:()=>tn,focus:()=>Ot,getApplication:()=>c,getContext:()=>Oe,getDebugInfo:()=>ne,getDeprecations:()=>je,getDeprecationsDuringCallback:()=>Ae,getResolver:()=>i,getRootElement:()=>He,getSettledState:()=>ve,getTestMetadata:()=>F,getWarnings:()=>Ne,getWarningsDuringCallback:()=>Le,hasEmberVersion:()=>f,isSettled:()=>Ee,pauseTest:()=>Re,registerDebugInfoHelper:()=>Z,registerHook:()=>X,render:()=>Ze,rerender:()=>rt,resetOnerror:()=>_e,resumeTest:()=>$e,runHooks:()=>Y,scrollTo:()=>on,select:()=>Gt,setApplication:()=>a,setContext:()=>Me,setResolver:()=>o,settled:()=>Te,setupApplicationContext:()=>me,setupContext:()=>We,setupOnerror:()=>ke,setupRenderingContext:()=>tt,tab:()=>Wt,tap:()=>Dt,teardownContext:()=>Ke,triggerEvent:()=>Kt,triggerKeyEvent:()=>Vt,typeIn:()=>nn,unsetContext:()=>Se,validateErrorHandler:()=>st,visit:()=>de,waitFor:()=>Zt,waitUntil:()=>j})
...
return"symbol"==typeof t?t:t+""}(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}class D{constructor(){W(this,"testName",void 0),W(this,"setupTypes",void 0),W(this,"usedHelpers",void 0),this.setupTypes=[],this.usedHelpers=[]}get isRendering(){return this.setupTypes.indexOf("setupRenderingContext")>-1&&this.usedHelpers.indexOf("render")>-1}get isApplication(){return this.setupTypes.indexOf("setupApplicationContext")>-1}}const K=new WeakMap
function F(e){return K.has(e)||K.set(e,new D),K.get(e)}function H(e){return null!==e&&("object"==typeof e||"function"==typeof e)&&"function"==typeof e.then}const U=new WeakMap
...
return H(o)?Promise.resolve(o).then(()=>n.slice(r)):n.slice(r)}(t,e)}function We(e,t={}){const n=e
...
const qe=(0,Qe.createTemplateFactory)({id:"WHHUe2Wm",block:'[[[46,[28,[37,1],null,null],null,null,null]],[],["component","-outlet"]]',moduleName:"/home/runner/work/ember-mobile-menu/ember-mobile-menu/node_modules/.pnpm/@ember+test-helpers@5.2.2_@babel+core@7.28.4/node_modules/@ember/test-helpers/dist/setup-rendering-context.js",isStrictMode:!1}),Ve=(0,Qe.createTemplateFactory)({id:"W/vQ3mUc",block:"[[],[],[]]",moduleName:"/home/runner/work/ember-mobile-menu/ember-mobile-menu/node_modules/.pnpm/@ember+test-helpers@5.2.2_@babel+core@7.28.4/node_modules/@ember/test-helpers/dist/setup-rendering-context.js",isStrictMode:!1}),Be=(0,Qe.createTemplateFactory)({id:"VQPn1bcs",block:'[[[8,[30,0,["ProvidedComponent"]],null,null,null]],[],[]]',moduleName:"/home/runner/work/ember-mobile-menu/ember-mobile-menu/node_modules/.pnpm/@ember+test-helpers@5.2.2_@babel+core@7.28.4/node_modules/@ember/test-helpers/dist/setup-rendering-context.js",isStrictMode:!1}),ze=Symbol()
...
return Ze(Ve)}function tt(e){F(e).setupTypes.push("setupRenderingContext")
...
return e.register("-top-level-view:main",{create:()=>i}),Ze(Ve).then(()=>((0,h.run)(i,"appendTo",He()),Te()))}).then(()=>(Object.defineProperty(t,"element",{configurable:!0,enumerable:!0,value:He(),writable:!1}),t))}Ge=(0,n(4928).A)(n(8935)).renderSettled
var nt=Ge
...
if(!t){const t=Ct(e)
throw new Error(`Element not found when calling \`blur('${t}')\`.`)}return It(t).then(()=>Te())}).then(()=>Y("blur","end",e))}function Mt(e){return Promise.resolve().then(()=>{const t=function(e){if(C(e))return null
let t=e
...
return Rt(t,n).then(Te)}).then(()=>Y("click","end",e,t))}function jt(e,t={}){const n={...St,...t}
...
function Lt(e){return e.activeElement||e.body}function Wt({backwards:e=!1,unRestrainTabIndex:t=!1}={}){return Promise.resolve().then(()=>function(e,t){const n=He()
let r,o
...
return Promise.resolve().then(()=>Y("tab","start",s)).then(()=>Lt(r)).then(e=>Y("tab","targetFound",e).then(()=>e)).then(t=>{const n=Pt("keydown",i)
...
function Qt(e,t){return e>64&&e<91?t.shiftKey?String.fromCharCode(e):String.fromCharCode(e).toLocaleLowerCase():t.shiftKey&&Ut[e]||Ht[e]}function qt(e,t,n,r=Ft){return Promise.resolve().then(()=>{let o
...
return Et(e,t,o)})}function Vt(e,t,n,r=Ft){return Promise.resolve().then(()=>Y("triggerKeyEvent","start",e,t,n)).then(()=>{if(!e)throw new Error("Must pass an element, selector, or descriptor to `triggerKeyEvent`.")
const o=ct(e)
if(!o){const t=Ct(e)
