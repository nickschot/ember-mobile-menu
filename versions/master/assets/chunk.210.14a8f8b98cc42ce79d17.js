"use strict";(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[210],{8210:(e,t,n)=>{let r
function o(e){r=e}function i(){return r}n.r(t),n.d(t,{blur:()=>xt,clearRender:()=>et,click:()=>$t,currentRouteName:()=>fe,currentURL:()=>me,doubleClick:()=>jt,fillIn:()=>Xt,find:()=>en,findAll:()=>tn,focus:()=>Ot,getApplication:()=>c,getContext:()=>Oe,getDebugInfo:()=>ne,getDeprecations:()=>je,getDeprecationsDuringCallback:()=>Ae,getResolver:()=>i,getRootElement:()=>He,getSettledState:()=>ve,getTestMetadata:()=>W,getWarnings:()=>Ne,getWarningsDuringCallback:()=>Le,hasEmberVersion:()=>f,isSettled:()=>Ee,pauseTest:()=>Re,registerDebugInfoHelper:()=>Z,registerHook:()=>X,render:()=>Ze,rerender:()=>rt,resetOnerror:()=>_e,resumeTest:()=>$e,runHooks:()=>Y,scrollTo:()=>on,select:()=>Gt,setApplication:()=>a,setContext:()=>Me,setResolver:()=>o,settled:()=>Te,setupApplicationContext:()=>pe,setupContext:()=>Fe,setupOnerror:()=>ke,setupRenderingContext:()=>tt,tab:()=>Ft,tap:()=>Dt,teardownContext:()=>Ke,triggerEvent:()=>Kt,triggerKeyEvent:()=>Vt,typeIn:()=>nn,unsetContext:()=>Se,validateErrorHandler:()=>st,visit:()=>de,waitFor:()=>Zt,waitForFocus:()=>sn,waitUntil:()=>j})
...
return"symbol"==typeof t?t:t+""}(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}class D{constructor(){F(this,"testName",void 0),F(this,"setupTypes",void 0),F(this,"usedHelpers",void 0),this.setupTypes=[],this.usedHelpers=[]}get isRendering(){return this.setupTypes.indexOf("setupRenderingContext")>-1&&this.usedHelpers.indexOf("render")>-1}get isApplication(){return this.setupTypes.indexOf("setupApplicationContext")>-1}}const K=new WeakMap
function W(e){return K.has(e)||K.set(e,new D),K.get(e)}function H(e){return null!==e&&("object"==typeof e||"function"==typeof e)&&"function"==typeof e.then}const U=new WeakMap
...
return null===e||(0,N.assert)("currentUrl should be a string, but was "+typeof e,"string"==typeof e),e}return t.location.getURL()}function pe(e){return W(e).setupTypes.push("setupApplicationContext"),Promise.resolve()}let ge
...
return H(o)?Promise.resolve(o).then(()=>n.slice(r)):n.slice(r)}(t,e)}function Fe(e,t={}){const n=e
...
function Ke(e,{waitForSettled:t=!0}={}){return Promise.resolve().then(()=>{!function(e){_e(),Pe.delete(e)}(e),ge=[],void 0!==globalThis.jQuery&&(globalThis.jQuery(document).off("ajaxSend",be),globalThis.jQuery(document).off("ajaxComplete",ye)),(0,N.setTesting)(!1),Se(),(0,De.destroy)(e.owner)}).finally(()=>{if(t)return Te()})}var We=n(4334)
...
const Qe=(0,qe.createTemplateFactory)({id:"FD+qA3tm",block:'[[[46,[28,[37,1],null,null],null,null,null]],[],["component","-outlet"]]',moduleName:"/home/runner/work/ember-mobile-menu/ember-mobile-menu/node_modules/.pnpm/@ember+test-helpers@5.4.1_@babel+core@7.28.5/node_modules/@ember/test-helpers/dist/setup-rendering-context.js",isStrictMode:!1}),Ve=(0,qe.createTemplateFactory)({id:"PkiUHEWH",block:"[[],[],[]]",moduleName:"/home/runner/work/ember-mobile-menu/ember-mobile-menu/node_modules/.pnpm/@ember+test-helpers@5.4.1_@babel+core@7.28.5/node_modules/@ember/test-helpers/dist/setup-rendering-context.js",isStrictMode:!1}),Be=(0,qe.createTemplateFactory)({id:"ffdDAzSu",block:'[[[8,[30,0,["ProvidedComponent"]],null,null,null]],[],[]]',moduleName:"/home/runner/work/ember-mobile-menu/ember-mobile-menu/node_modules/.pnpm/@ember+test-helpers@5.4.1_@babel+core@7.28.5/node_modules/@ember/test-helpers/dist/setup-rendering-context.js",isStrictMode:!1}),ze=Symbol()
...
return null}(t)
throw new Error("Must use an element, selector string, or DOM element descriptor")}}function dt(e){return _(e)?e:ct(e)}function ft(...e){return e}function ht(e,t,...n){"undefined"!=typeof location&&-1!==location.search.indexOf("testHelperLogging")&&console.log(`${e}(${[mt(t),...n.filter(Boolean)].join(", ")})`)}function mt(e){let t
...
function Lt(e){return e.activeElement||e.body}function Ft({backwards:e=!1,unRestrainTabIndex:t=!1}={}){return Promise.resolve().then(()=>function(e,t){const n=He()
let r,o
...
return Et(o,t,n).then(Te)}).then(()=>Y("triggerEvent","end",e,t,n))}X("tab","start",e=>{ht("tab",e)}),X("tap","start",e=>{ht("tap",e)}),X("triggerEvent","start",(e,t)=>{ht("triggerEvent",e,t)}),X("triggerKeyEvent","start",(e,t,n)=>{ht("triggerKeyEvent",e,t,n)})
...
return r||(r=`waitForFocus timed out waiting for selector "${Ct(e)}"`),j(()=>{const t=ct(e)
