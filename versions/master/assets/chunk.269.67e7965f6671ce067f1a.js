...
function Le(e,{waitForSettled:t=!0}={}){return Promise.resolve().then(()=>{!function(e){Pe(),Ee.delete(e)}(e),me=[],void 0!==globalThis.jQuery&&(globalThis.jQuery(document).off("ajaxSend",ge),globalThis.jQuery(document).off("ajaxComplete",we)),(0,$.setTesting)(!1),Me(),(0,Fe.destroy)(e.owner)}).finally(()=>{if(t)return ve()})}var We=n(1953)
function De(){const e=xe()
...
return e.register("-top-level-view:main",{create:()=>i}),Ge(Be).then(()=>((0,h.run)(i,"appendTo",De()),ve()))}).then(()=>(Object.defineProperty(t,"element",{configurable:!0,enumerable:!0,value:De(),writable:!1}),t))}Xe=(0,n(3277).A)(n(8935)).renderSettled
var et=Xe
