...
t&&(0,N.registerWarnHandler)((e,n,r)=>{n&&t.includes(n.id)||r.apply(null,[e,n])}),n&&(0,N.registerWarnHandler)((e,t,r)=>{t&&n.includes(t.id),r.apply(null,[e,t])})}const V=new Map
function z(e,t){return`${e}:${t}`}function Y(e,t,n){const r=z(e,t)
let o=V.get(r)
return void 0===o&&(o=new Set,V.set(r,o)),o.add(n),{unregister(){o.delete(n)}}}function X(e,t,...n){const r=V.get(z(e,t))||new Set,o=[]
...
const{owner:r}=n
return F(n).usedHelpers.push("visit"),Promise.resolve().then(()=>X("visit","start",e,t)).then(()=>{const n=r.visit(e,t)
...
const Be=(0,qe.createTemplateFactory)({id:"riwiiRU5",block:'[[[46,[28,[37,1],null,null],null,null,null]],[],["component","-outlet"]]',moduleName:"/home/runner/work/ember-mobile-menu/ember-mobile-menu/node_modules/.pnpm/@ember+test-helpers@5.2.2_@babel+core@7.28.3/node_modules/@ember/test-helpers/dist/setup-rendering-context.js",isStrictMode:!1}),Qe=(0,qe.createTemplateFactory)({id:"pnWpdOqw",block:"[[],[],[]]",moduleName:"/home/runner/work/ember-mobile-menu/ember-mobile-menu/node_modules/.pnpm/@ember+test-helpers@5.2.2_@babel+core@7.28.3/node_modules/@ember/test-helpers/dist/setup-rendering-context.js",isStrictMode:!1}),Ve=(0,qe.createTemplateFactory)({id:"nOCBYGmm",block:'[[[8,[30,0,["ProvidedComponent"]],null,null,null]],[],[]]',moduleName:"/home/runner/work/ember-mobile-menu/ember-mobile-menu/node_modules/.pnpm/@ember+test-helpers@5.2.2_@babel+core@7.28.3/node_modules/@ember/test-helpers/dist/setup-rendering-context.js",isStrictMode:!1}),ze=Symbol()
...
return t||(e.register("template:-outlet",Be),t=Xe(e,"template:-outlet")),t}(r),s=t?.owner||r
var u
u=e,(0,Ue.getInternalComponentManager)(u,!0)&&(n={ProvidedComponent:e},e=Ve),Je+=1
...
return o.setOutletState(c),Te()}).then(()=>X("render","end"))}function et(){const e=Oe()
if(!e||!Ye(e))throw new Error("Cannot call `clearRender` without having first called `setupRenderingContext`.")
return Ze(Qe)}function tt(e){F(e).setupTypes.push("setupRenderingContext")
...
return e.register("-top-level-view:main",{create:()=>i}),Ze(Qe).then(()=>((0,h.run)(i,"appendTo",He()),Te()))}).then(()=>(Object.defineProperty(t,"element",{configurable:!0,enumerable:!0,value:He(),writable:!1}),t))}Ge=(0,n(9682).A)(n(8935)).renderSettled
var nt=Ge
...
return null}(t)
throw new Error("Must use an element, selector string, or DOM element descriptor")}}function dt(e){return _(e)?e:ct(e)}function ft(...e){return e}function ht(e,t,...n){"undefined"!=typeof location&&-1!==location.search.indexOf("testHelperLogging")&&console.log(`${e}(${[pt(t),...n.filter(Boolean)].join(", ")})`)}function pt(e){let t
...
function Et(e,t,n={}){return Promise.resolve().then(()=>X("fireEvent","start",e)).then(()=>X(`fireEvent:${t}`,"start",e)).then(()=>{if(!e)throw new Error("Must pass an element to `fireEvent`")
let r
if(bt(t))r=Pt(t,n)
...
return e.dispatchEvent(r),r}).then(n=>X(`fireEvent:${t}`,"end",e).then(()=>n)).then(t=>X("fireEvent","end",e).then(()=>t))}function Tt(e,t={}){const n=document.createEvent("Events"),r=void 0===t.bubbles||t.bubbles,o=void 0===t.cancelable||t.cancelable
delete t.bubbles,delete t.cancelable,n.initEvent(e,r,o)
for(const i in t)n[i]=t[i]
return n}function Pt(e,t={}){const n={...gt,...t}
let r,o
try{return r=new KeyboardEvent(e,n),Object.defineProperty(r,"keyCode",{get:()=>parseInt(n.keyCode)}),Object.defineProperty(r,"which",{get:()=>parseInt(n.which)}),r}catch{}try{r=document.createEvent("KeyboardEvents"),o="initKeyboardEvent"}catch{}if(!r)try{r=document.createEvent("KeyEvents"),o="initKeyEvent"}catch{}return r&&o?r[o](e,n.bubbles,n.cancelable,window,n.ctrlKey,n.altKey,n.shiftKey,n.metaKey,n.keyCode,n.charCode):r=Tt(e,t),r}const kt=["A","SUMMARY"]
function _t(e){return!_(e)&&!C(e)&&(M(e)?!e.disabled:!(!I(e)&&!function(e){return kt.indexOf(e.tagName)>-1}(e))||e.hasAttribute("tabindex"))}function Ct(e){const t=lt(e)?at(e):null
return t?t.description||"<unknown descriptor>":`${e}`}function It(e,t=null){if(!_t(e))throw new Error(`${e} is not focusable`)
const n=document.hasFocus&&!document.hasFocus(),r=null!==t
r||e.blur()
const o={relatedTarget:t}
return n||r?Promise.resolve().then(()=>Et(e,"blur",{bubbles:!1,...o})).then(()=>Et(e,"focusout",o)):Promise.resolve()}function xt(e=document.activeElement){return Promise.resolve().then(()=>X("blur","start",e)).then(()=>{const t=ct(e)
if(!t){const t=Ct(e)
throw new Error(`Element not found when calling \`blur('${t}')\`.`)}return It(t).then(()=>Te())}).then(()=>X("blur","end",e))}function Mt(e){return Promise.resolve().then(()=>{const t=function(e){if(C(e))return null
let t=e
for(;t&&!_t(t);)t=t.parentElement
return t}(e),n=document.activeElement&&document.activeElement!==t&&_t(document.activeElement)?document.activeElement:null
...
return t?Promise.resolve():Promise.resolve().then(()=>Et(e,"focus",{bubbles:!1})).then(()=>Et(e,"focusin")).then(()=>Te())}).catch(()=>{})}function Ot(e){return Promise.resolve().then(()=>X("focus","start",e)).then(()=>{if(!e)throw new Error("Must pass an element, selector, or descriptor to `focus`.")
const t=ct(e)
if(!t){const t=Ct(e)
throw new Error(`Element not found when calling \`focus('${t}')\`.`)}if(!_t(t))throw new Error(`${t} is not focusable`)
return Mt(t).then(Te)}).then(()=>X("focus","end",e))}Y("blur","start",e=>{ht("blur",e)}),Y("focus","start",e=>{ht("focus",e)}),Y("click","start",e=>{ht("click",e)})
const St={buttons:1,button:0}
function Rt(e,t){return Promise.resolve().then(()=>Et(e,"mousedown",t)).then(t=>_(e)||t?.defaultPrevented?Promise.resolve():Mt(e)).then(()=>Et(e,"mouseup",t)).then(()=>Et(e,"click",t))}function $t(e,t={}){const n={...St,...t}
...
return Rt(t,n).then(Te)}).then(()=>X("click","end",e,t))}function jt(e,t={}){const n={...St,...t}
...
return function(e,t){return Promise.resolve().then(()=>Et(e,"mousedown",t)).then(t=>_(e)||t?.defaultPrevented?Promise.resolve():Mt(e)).then(()=>Et(e,"mouseup",t)).then(()=>Et(e,"click",t)).then(()=>Et(e,"mousedown",t)).then(()=>Et(e,"mouseup",t)).then(()=>Et(e,"click",t)).then(()=>Et(e,"dblclick",t))}(t,n).then(Te)}).then(()=>X("doubleClick","end",e,t))}Y("doubleClick","start",e=>{ht("doubleClick",e)})
...
return Promise.resolve().then(()=>X("tab","start",s)).then(()=>Lt(r)).then(e=>X("tab","targetFound",e).then(()=>e)).then(t=>{const n=Pt("keydown",i)
...
return Et(e,"keyup",i).then(()=>e)}).then(e=>{if(!t&&e.tabIndex>0)throw new Error(`tabindex of greater than 0 is not allowed. Found tabindex=${e.tabIndex}`)}).then(()=>X("tab","end",s))}(e,t)).then(()=>Te())}function Kt(e,t={}){return Promise.resolve().then(()=>X("tap","start",e,t)).then(()=>{if(!e)throw new Error("Must pass an element, selector, or descriptor to `tap`.")
const n=ct(e)
if(!n){const t=Ct(e)
...
return Et(r,t,n).then(Te)}).then(()=>X("triggerEvent","end",e,t,n))}Y("tab","start",e=>{ht("tab",e)}),Y("tap","start",e=>{ht("tap",e)}),Y("triggerEvent","start",(e,t)=>{ht("triggerEvent",e,t)}),Y("triggerKeyEvent","start",(e,t,n)=>{ht("triggerKeyEvent",e,t,n)})
...
function qt(e,t){return e>64&&e<91?t.shiftKey?String.fromCharCode(e):String.fromCharCode(e).toLocaleLowerCase():t.shiftKey&&Ut[e]||Ht[e]}function Bt(e,t,n,r=Ft){return Promise.resolve().then(()=>{let o
...
return Et(e,t,o)})}function Qt(e,t,n,r=Ft){return Promise.resolve().then(()=>X("triggerKeyEvent","start",e,t,n)).then(()=>{if(!e)throw new Error("Must pass an element, selector, or descriptor to `triggerKeyEvent`.")
const o=ct(e)
if(!o){const t=Ct(e)
...
return zt(n,t,"fillIn"),Mt(n).then(()=>(n.value=t,n))}if(I(n))return Mt(n).then(()=>(n.innerHTML=t,n))
throw new Error("`fillIn` is only usable on form controls or contenteditable elements.")}).then(e=>Et(e,"input").then(()=>Et(e,"change")).then(Te)).then(()=>X("fillIn","end",e,t))}function Xt(e,t){return`${e} when calling \`select('${Ct(t)}')\`.`}function Gt(e,t,n=!1){return Promise.resolve().then(()=>X("select","start",e,t,n)).then(()=>{if(!e)throw new Error("Must pass an element, selector, or descriptor to `select`.")
...
if(!function(e){return!C(e)&&"SELECT"===e.tagName}(n))throw new Error(Xt("Element is not a HTMLSelectElement",e))
...
o&&(t.indexOf(o.value)>-1?o.selected=!0:n||(o.selected=!1))}return Et(e,"input").then(()=>Et(e,"change")).then(Te)}).then(()=>X("select","end",e,t,n))}function Jt(e){if("string"==typeof e)return He().querySelectorAll(e)
{const t=at(e)
if(t)return function(e){let t=lt(e)?at(e):e
if(!t)return[]
...
if(t.length===r)return t}:()=>ct(e),j(o,{timeout:n,timeoutMessage:i})})}function en(e){if(!e)throw new Error("Must pass a selector to `find`.")
...
return Array.from(Jt(e))}function nn(e,t,n={}){return Promise.resolve().then(()=>X("typeIn","start",e,t,n)).then(()=>{if(!e)throw new Error("Must pass an element, selector, or descriptor to `typeIn`.")
const r=ct(e)
if(!r){const t=Ct(e)
...
e.innerHTML=n}return Et(e,"input")}).then(()=>Bt(e,"keyup",r,n))}}(e,t))
return r.reduce((e,t)=>e.then(()=>function(e){return new Promise(t=>{setTimeout(t,e)})}(n)).then(t),Promise.resolve())}(r,t,o)).then(()=>Et(r,"change")).then(Te).then(()=>X("typeIn","end",e,t,n))})}function rn(e,t){return`${e} when calling \`scrollTo('${Ct(t)}')\`.`}function on(e,t,n){return Promise.resolve().then(()=>X("scrollTo","start",e)).then(()=>{if(!e)throw new Error("Must pass an element, selector, or descriptor to `scrollTo`.")
...
if(!k(r)){let t
throw t=C(r)?"Document":r.nodeType,new Error(rn(`"target" must be an element, but was a ${t}`,e))}return r.scrollTop=n,r.scrollLeft=t,Et(r,"scroll").then(Te)}).then(()=>X("scrollTo","end",e))}Y("fillIn","start",(e,t)=>{ht("fillIn",e,t)}),Y("typeIn","start",(e,t)=>{ht("typeIn",e,t)})}}])
